import pic1 from "../images/God-of-War-Ragnarok.jpg";
import pic2 from "../images/Horizon-Forbidden-West.jpg";
import pic3 from "../images/Ratchet-and-Clank-Rift-Apart.jpg";
import pic4 from "../images/Marvels-Spiderman-Miles-Morales.jpg";
import pic5 from "../images/Elden-Ring.jpg";
import pic6 from "../images/Marvels-Avengers.jpg";
import pic7 from "../images/Sonic-Forces.jpg";
import pic8 from "../images/It-Takes-Two.jpg";
import pic9 from "../images/NBA-2K23-Standard-Edition.jpg";
import pic10 from "../images/Assassins-Creed-Valhalla.jpg";
import pic11 from "../images/Crash-Bandicoot-4.jpg";
import pic12 from "../images/Rayman-Legends.jpg";
import pic13 from "../images/Spyro-Reignited-Trilogy.jpg";
import { SonyGameArticle } from "../features/games/games.d";

export const psGamesArr: SonyGameArticle[] = [
    {
        id: "14739",
    ...
    },
    {
        ...
        image: pic2,
        description: "Journey with her across a beautiful post-apocalyptic world dominated by machine-like creatures and experience immersive gameplay as she faces staggering odds in this open-world action-adventure RPG video game.",
        company: "Sony Playstation",
        price: 37.99,
        isGettingBuied: false
    },
    ...
    },
    {
        ...
        image: pic5,
        description: "The Golden Order has been broken. Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between. ELDEN RING, developed by FromSoftware Inc.and produced by BANDAI NAMCO Entertainment Inc., is a fantasy action- RPG and FromSoftware’s largest game to date, set within a world full of mystery and peril.",
        company: "Sony Playstation",
        price: 59.99,
        isGettingBuied: false
    },
    ...
    {
        id: "508",
        nameOfGame: "Sonic Forces for PS4",
        image: pic7,
    ...
    {
        id: "2146",
        nameOfGame: "Assassin's Creed Valhalla for PS4",
        image: pic10,
    ...
    {
        id: "2283",
        nameOfGame: "Crash Bandicoot 4: It's About Time for PS4",
        image: pic11,
    ...
    {
        id: "90",
        nameOfGame: "Rayman Legends for PS4",
        image: pic12,
        description: "The Glade of Dreams is in trouble once again! During a 100-year nap, the nightmares multiplied and spread, creating new monsters even more terrifying than before! These creatures are the stuff of legend: dragons, giant toads, sea monsters, and even evil luchadores. With the help of Murfy, Rayman and Globox awaken and must now help fight these nightmares and save the Teensies!",
        company: "Sony Playstation",
        price: 14.99,
        isGettingBuied: false
    },
    {
        id: "992",
        nameOfGame: "Spyro: Reignited Trilogy for PS4",
        image: pic13,
        description: "The Spyro Reignited Trilogy brings the heat like never before by recreating the series’ original 3 games: Spyro the Dragon™, Spyro™ 2 Ripto's Rage! and Spyro™ Year of the Dragon. Explore the sweeping lands, re-encounter fiery personalities, and relive the adventure in fully remastered glory.",
        company: "Sony Playstation",
        price: 22.99,
        isGettingBuied: false
    }
